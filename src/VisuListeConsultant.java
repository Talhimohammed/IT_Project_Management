 ...
 * @author user
 */
public class VisuListeConsultant extends javax.swing.JFrame {

    /**
     * Creates new form VisuListeConsultant
     */ 
    String f ; 
    public VisuListeConsultant( String f) {
        initComponents(); 
        this.f=f; 
        this.loadDriver(); 
        this.listconsultant();
      ...
      Connection newConnection() { 
       ...
       void loadDriver() { 
		...
		try{
			...
			String query = "SELECT Code,Code_Projet,Nom,Prenom,Email,Type,Date_Debut,Date_Fin FROM ressource WHERE Code_Projet = "+f; 
                        
			ResultSet rs = st.executeQuery(query); 
                        //Table.setModel(DbUtils.resultSetToTableModel(rs)); 
                        Object column []={"Code de consultant","Code de projet","Nom","Prenom","Email","Type de consultant(e)","Date début","Date Fin"}; 
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Code de  projet : ");

        jButton5.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jButton5.setIcon(new javax.swing.ImageIcon("C:\\Users\\user\\Desktop\\PFE\\icons8-voir-les-détails-filled-50.png")); // NOI18N
        jButton5.setText("    la table des activités ");
        ...
        jButton3.setIcon(new javax.swing.ImageIcon("C:\\Users\\user\\Desktop\\PFE\\icons8-gmail-48.png")); // NOI18N
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\user\\Desktop\\PFE\\icons8-calendrier-48.png")); // NOI18N
    ...
    private void TableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMousePressed
        ...
        t1.setText((String) Table.getValueAt(i,6));  
        t2.setText((String) Table.getValueAt(i,7));  
        t3.setText((String) Table.getValueAt(i,1));
         ...
         Connection conn = null ;      
          ...
          if(i==-1){ 
               JOptionPane.showMessageDialog(this,"veuillez sélectionner un(e) consultant(e) ");
			    ...
			    java.sql.PreparedStatement  pst = conn.prepareStatement("UPDATE ressource SET Code_Projet = NULL WHERE Code=?"); 
			   
                            pst.setString(1,(String)Table.getValueAt(i,0));  
			    ...
			    if(rs==1 ) {
			        JOptionPane.showMessageDialog(this,"la suppression est effectuée"); 
        ...
        // TODO add your handling code here:  
          ...
          int i = Table.getSelectedRow();  
               if(i==-1){ 
			    ...
			    conn = newConnection(); 
			    Statement st = conn.createStatement(); 
			    java.sql.PreparedStatement  pst = conn.prepareStatement("UPDATE ressource SET Date_Debut = ?,Date_Fin = ? WHERE Code=?"); 
			    pst.setString(1,t1.getText());
                            pst.setString(2,t2.getText());
                            pst.setString(3,(String)Table.getValueAt(i,0));  
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        GMAIL A = new GMAIL((String)Table.getValueAt(i,4).toString()); 
        A.setVisible(true); 
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        TableActivite a = new TableActivite((String)Table.getValueAt(i,0).toString()); 
        a.setVisible(true);  
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here: 
         MessageFormat header = new MessageFormat("Liste des consultants"); 
