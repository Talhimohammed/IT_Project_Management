 ...
 * @author user
 */
public class ListeClientD extends javax.swing.JFrame {

    /**
     * Creates new form ListeClientD
     */
    public ListeClientD() {
        initComponents();  
        this.loadDriver();  
    ...
    private void initComponents() {
        ...
        jLabel1.setText("La liste des Clients ");
        ...
        jButton2.setIcon(new javax.swing.ImageIcon("C:\\Users\\user\\Desktop\\PFE\\icons8-impression-40.png")); // NOI18N
          ...
          if(i==-1){ 
               JOptionPane.showMessageDialog(this,"veuillez sélectionner un client ");
			    ...
			    java.sql.PreparedStatement  pst = conn.prepareStatement("DELETE FROM Clients WHERE Code_Client = ?"); 
                            ...
                            pst.setString(1,Table.getValueAt(i,3).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListeClientD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListeClientD().setVisible(true);
            }
        });
    }
